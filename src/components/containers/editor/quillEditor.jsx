...
import { style } from "../../styles/editor.style.js";
import { Tooltip } from "../../styled-elements";
import { buttonList, customButtonList } from "./util.js";
          ...
          {buttonList.map((button) => (
            <React.Fragment>
              <button
                ...
                data-for={button.for}
              />
              <Tooltip id={button.for} effect="solid" />
            </React.Fragment>
          ))}
          <Tooltip id="italic" effect="solid" />
          {customButtonList.map((button) => (
            <React.Fragment>
              <button
                style={style.toolbar.custom_button}
                className={button.className}
                data-tip={button.tip}
                data-for={button.for}
              >
